  ...
  return (
    <figure className={cn("min-w-0", className)}>
      <div
        ...
        aria-hidden="true"
        className="pointer-events-none select-none border rounded-2xl border-rule-strong bg-paper p-3 sm:p-4"
      >
        {children}
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="panel mt-3">
        <h3 className="label-caps border-b border-rule px-4 py-2">
          Recent activity
        </h3>
