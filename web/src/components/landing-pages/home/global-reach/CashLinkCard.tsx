    ...
    <div className="panel flex flex-col h-full">
      <div className="p-6">
        ...
        <p className="text-ink-muted leading-relaxed mb-6">
          Send funds with a simple link. Share via text or WhatsApp and claim instantly
          with zero delays or hidden fees.
        </p>

        <Link to="/register">
          <Button variant="primary" size="lg" className="w-full sm:w-auto" trailing={<ArrowIcon size={18} />}>
            Send a Cash Link
          </Button>
        </Link>
      </div>
      ...
      <div className="relative border-t border-rule bg-paper p-6">
        <div className="max-w-sm mx-auto">
          <div className="bg-paper-raised border border-rule rounded-[var(--radius-panel)] p-4">
            <div className="flex items-center gap-3 mb-4">
            ...
            <div className="bg-paper border border-rule rounded-[var(--radius-panel)] p-3 mb-4">
              <p className="text-sm text-ink-muted break-all">
                cowri.app/claim/7x9k2m
              </p>
            </div>

            <Button variant="primary" size="lg" className="w-full" trailing={<ArrowIcon size={16} />}>
              Claim ₦10,000
            </Button>
          </div>
        </div>
